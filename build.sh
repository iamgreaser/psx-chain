...
echo cc && mipsel-none-elf-gcc -c -fomit-frame-pointer -fno-stack-protector -G0 -O3 -msoft-float -nostdlib -mips1 -march=3000 -o obj/main.o main.c -I . && \
echo as && mipsel-none-elf-as -G1 -o obj/head.o head.S && \
echo ld && mipsel-none-elf-ld -T link.ld -o obj/${EXE_NAME}.elf obj/head.o obj/main.o -L/usr/local/mipsel-none-elf/lib/soft-float/ -L/usr/local/lib/gcc/mipsel-none-elf/4.7.0/soft-float/ -lm -lc -lgcc -lnullmon && \
